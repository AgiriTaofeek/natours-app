...
router.route('/').get(createBookingCheckout, isLoggedIn, getOverview) //We added the createBookingCheckout because we used the home route '/' to send some data via querystring for our stripe success_url temporary solution
